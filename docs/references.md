...
| Project | Role in Money_Never_sleep |
| --- | --- |
...
Initial rule: use these projects for architecture and integration guidance. Do not vendor their source into Money_Never_sleep until a specific feature requires a reviewed port.
